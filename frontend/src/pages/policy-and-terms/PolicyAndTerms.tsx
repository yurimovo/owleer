...
export const PolicyAndTerms = () => {
  return (
    <div style={{ padding: 40 }}>
      ...
      >
        <img style={{ height: 250, width: 250 }} src={logo} alt="Logo" />
      </div>
      <div>
        <div>
          <Typography align="center" variant="h3" style={{ margin: 30 }}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to owleer.io, Zarhin 10,Raanana.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>
              By email: <a href="mailto:office@owleer.io">office@owleer.io</a>
            </li>
          </ul>
        </div>
      </div>
